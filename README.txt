...
Install
  ...
  * So, I created a simplistic .bat file which will run npm install in both folders, back and frontend, and also create the database. After that you can manually run npm run dev inside the backend folder and npm start inside the frontend folder. It will be all up and runnin.
